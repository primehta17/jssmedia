...
export default function VideoEditing() {
  useEffect(() => {
    document.title = 'SHARIAH PREMIUMS'
            ...
            <Col md={8}>
              <div className='Product-description-card'>
                <ul className='product-desc-list'>
                  ...
                  <li><span> Portfolio:</span>Feature showreels or clips from projects we've edited to demonstrate our skills.</li>
                </ul>
              </div>
              <Row>
                <Col lg={6}>
