...
export default function ReelPromotion() {
  useEffect(() => {
    document.title = 'BURSA OPTIMAL'
  ...
  const handleSubmit = (event) => {
    ...
    axios.post('/api/submit-products', inputs).then(function (response) {
    ...
    <Fragment>
      <div className='product-pricing-area'>
        <Container className='section-content'>
          <h2><span>Reel Promotion</span></h2>
        </Container>
      </div>
            ...
            <Col md={8}>
              <div className='Product-description-card'>
                <ul className='product-desc-list'>
                  ...
                  <li><span> Portfolio: </span>  Share examples of reels we've promoted that have achieved significant reach and engagement.</li>
                </ul>
              </div>
              <Row>
                <Col lg={6}>
